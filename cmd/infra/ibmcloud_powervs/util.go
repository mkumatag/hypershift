...
// getStartToken ...
// parses the given url string and gets the 'start' query param
...
// pagingHelper ...
// while listing resources, can use this to get the start token for getting the next set of resources for processing
